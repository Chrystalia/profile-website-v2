        ...
        @foreach ($achievements as $achievement)
            <li class="mb-10 ml-4">
                ...
                <a href="/achievements/{{ $achievement['slug'] }}">
                    <h3 class="text-lg font-semibold hover:{{ $achievement['text_color'] }}">{{ $achievement['event'] }}</h3>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-slate-500"> {{ Str::limit($achievement['description']) }} </p>
                </a>
